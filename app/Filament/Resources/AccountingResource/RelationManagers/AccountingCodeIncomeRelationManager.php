...
class AccountingCodeIncomeRelationManager extends RelationManager
{
    protected static string $relationship = 'codes';

    public static function getTitle(\Illuminate\Database\Eloquent\Model $ownerRecord, string $pageClass): string
    {
        return 'Códigos de Ingreso'; // Título personalizado del encabezado
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\Filter::make('ingresos')
                    ->label('Ingreso')
                    ->query(fn (Builder $query) => $query->whereRelation('movement', 'type', 'Ingreso')) // Filtra los egresos
